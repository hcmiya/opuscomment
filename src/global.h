...
GLOBAL uint8_t const * const new_vendor_string_ascii
	// "Unknown (This string was generated by a metadata editor)"
	GLOBAL_VAL("\x55\x6e\x6b\x6e\x6f\x77\x6e\x20\x28\x54\x68\x69\x73\x20\x73\x74"
		...
		"\x20\x65\x64\x69\x74\x6f\x72\x29"
	);
